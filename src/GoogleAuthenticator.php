...
class GoogleAuthenticator {
	...
	public function getQRCode(String $name, String $secret, String $title = null, int $ret_type = 1, String $out_file = null) {
		...
		switch ($ret_type) {
		case 0: //直接输出图片到浏览器
			$qrcode = \tekintian\TekinQR::getQRImg($urlencoded);
			break;
		case 1: // 返回base64图片
			$qrcode = \tekintian\TekinQR::getQRImg($urlencoded, 10, null, 1);
			break;
		case 2: // 写入二维码到 $out_file
			$qrcode = \tekintian\TekinQR::getQRImg($urlencoded, 10, null, 2, $out_file);
			break;
		default:
			$qrcode = \tekintian\TekinQR::getQRImg($urlencoded, 10, null, 1);
			break;
